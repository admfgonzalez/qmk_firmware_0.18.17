...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_SLASH] = ACTION_TAP_DANCE_DOUBLE(KC_PSLS, RALT(KC_MINS)),
    [TD_LEFT_PAR_BRA] = ACTION_TAP_DANCE_DOUBLE(S(KC_QUOT), KC_QUOT),
    [TD_RIGHT_PAR_BRA] = ACTION_TAP_DANCE_DOUBLE(S(KC_NUHS), KC_NUHS),
    [TD_BRACKET] = ACTION_TAP_DANCE_DOUBLE(S(KC_QUOT), S(KC_NUHS)),
};
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |LShift|   A  |   S  |   D  |   F  |   G  |-------.    ,-------|   H  |   J  |   K  |   L  | DOWN |  []  |
 * |------+------+------+------+------+------|  MUTE |    |       |------+------+------+------+------+------|
 * |LCTRL |   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   Ñ  | LEFT |  UP  |RIGTH |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            |  Alt | LOWER |  WIN |SPACE | /SPACE  /       \ENTER \  |ENTER |ALTgr |RAISE |RShift|
 *            |      |       |      |      |/       /         \      \ |      |      |      |      |
 *            `------------------------------------'           '------''---------------------------'
 */
  [_QWERTY] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  TD(TD_CAPLOCK),   KC_A,   KC_S,    KC_D,    KC_F,    KC_G,              KC_H,    KC_J,   KC_K,    KC_L,    KC_DOWN, TD(TD_BRACKET),
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
  KC_LCTRL, KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,  KC_MUTE,   KC_CUSTOM,KC_N,   KC_M,   KC_SCLN, KC_LEFT, KC_UP, KC_RIGHT,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
                 KC_LALT, KC_LOWER, KC_LWIN, KC_SPC ,  KC_SPC,     KC_ENT,  KC_ENT,   KC_ALGR, KC_RAISE, KC_RSFT
  //            \--------+--------+--------+---------+-------|   |--------+---------+--------+---------+-------/
),
 ...
 * |LCTRL |  (   |  )   |  ,;  |  .:  |  -_  |-------|    |-------|   1  |   2  |   3  |   +  |  >>  | Vol- |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            |  Alt | LOWER |  WIN |SPACE | /SPACE  /       \Enter \  |   0  |   .  |RAISE |  =   |
 *            |      |       |      |      |/       /         \      \ |      |      |      |      |
 *            `-----------------------------------'            '------''---------------------------'
 */
[_LOWER] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  _______, S(KC_1),  KC_PEQL, KC_UNDS, RALT(KC_QUOT), TD(TD_SLASH),        KC_KP_7, KC_KP_8, KC_KP_9, KC_PAST, KC_MPRV, KC__VOLUP, \
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  _______,KC_NUBS,TD(TD_LEFT_PAR_BRA),TD(TD_RIGHT_PAR_BRA),KC_MINS,S(KC_2),KC_KP_4, KC_KP_5, KC_KP_6, KC_PMNS, KC_MPLY, KC__MUTE, \
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
  _______,S(KC_8), S(KC_9),  KC_COMM, KC_DOT,  KC_SLSH,_______,   _______, KC_KP_1, KC_KP_2, KC_KP_3, KC_PPLS, KC_MNXT, KC__VOLDOWN, \
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
                 _______, _______, _______, _______, _______,     _______, KC_KP_0,  KC_DOT,  _______,  KC_PEQL
  //            \--------+--------+--------+---------+-------|   |--------+---------+--------+---------+-------/
),
/* RAISE
 * ,-----------------------------------------.                    ,-----------------------------------------.

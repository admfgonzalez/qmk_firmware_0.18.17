...
[_LOWER] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  _______,  KC_AT,  KC_QUES, KC_AMPR, KC_CIRC, KC_ASTR,                   KC_KP_7, KC_KP_8, KC_KP_9, KC_PAST, KC_MPRV, KC__VOLUP, \
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  _______,  KC_UNDS,KC_EXLM, KC_COLN, KC_GRV,  KC_QUOT,                   KC_KP_4, KC_KP_5, KC_KP_6, KC_PMNS, KC_MPLY, KC__MUTE, \
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
  _______,KC_LPRN,KC_RPRN,TD(TD_SLASH),KC_LT,  KC_GT,_______,   _______,  KC_KP_1, KC_KP_2, KC_KP_3, KC_PPLS, KC_MNXT, KC__VOLDOWN, \
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|

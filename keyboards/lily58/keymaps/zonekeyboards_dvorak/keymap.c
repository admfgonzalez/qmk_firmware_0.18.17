 ...
 * |------+------+------+------+------+------|  [{   |    |  ]}   |------+------+------+------+------+------|
 * |LCTRL |  -_  |   Q  |   J  |   K  |   X  |-------|    |-------|   B  |   M  |   W  |   V  |   Z  |AltGr |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 ...
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  KC_TAB,          KC_DOT,  KC_COMM, KC_SCLN, KC_P,    KC_Y,                                                 KC_F,    KC_G,    KC_C,    KC_H,    KC_L,    A(KC_GRV), \
  TD(TD_CAPLOCK),  KC_A,    KC_O,    KC_E,    KC_U,    KC_I,                                                 KC_D,    KC_R,    KC_T,    KC_N,    KC_S,    KC_QUOT, \
  KC_LCTRL,        KC_SLSH, KC_Q,    KC_J,    KC_K,    KC_X,  TD(TD_LEFT_PAR_BRA),   TD(TD_RIGHT_PAR_BRA),   KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,    KC_ALGR, \
...
[_LOWER] = LAYOUT( \
  ...
  _______, KC_GRV,  S(KC_SLSH), KC_PLUS, KC_CIRC, KC_ASTR,                                            KC_KP_7, KC_KP_8, KC_KP_9, KC_PAST, KC_MRWD, KC__VOLUP, \
  _______, S(KC_COMMA), S(KC_DOT), KC_MINS, KC_QUOT, S(KC_QUOTE),                                   KC_KP_4, KC_KP_5, KC_KP_6, KC_PMNS, KC_MPLY, KC__MUTE, \
